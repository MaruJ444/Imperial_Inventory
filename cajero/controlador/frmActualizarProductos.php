                    ...
                    <div class="card-body">
                        <form id="form1" name="form1" method="post" action="validarActualizarProducto.php">
                            ...
                            <div class="form-group">
                                ...
                                <input name="cantidad" type="number" id="cantidad" value="<?php echo $producto->Cantidad ?>" class="form-control" required oninput="validarNumerosPositivos(this)" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="precio" type="text" id="precio" value="<?php echo $producto->precio ?>" class="form-control" required oninput="validarNumerosPositivos(this)" />
                            </div>
                            <div class="form-row">
